...
class _CreateButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
        onPressed: (() =>
            HistoryModelProvider.read(context)?.model.createPosts()),
...
class _PostRowWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final post = HistoryModelProvider.read(context)!.model.posts[index];
    // return Visibility(
    //   visible: isLoaded,
    //   child: ListView.builder(
    //     scrollDirection: Axis.vertical,        //////59:40
    //     shrinkWrap: true,
          ...
          return Column(
            ...
            children: <Widget>[
              ListTile(
                ...
                title: Text(post.id.toString() /*posts![index].date*/),
                subtitle: Container(
                    ...
                    children: [
                      TableRow(children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                              post.title /*"Показания: ${posts![index].indication}"*/,
                              textAlign: TextAlign.left,
                              style:
                      ...
                      TableRow(children: [
                        Padding(
                          padding: const EdgeInsets.only(top: 5),
                          child: Text(
                              post.title /*'Способ: ${posts![index].sendType}'*/,
                              textAlign: TextAlign.left),
                        ),
                        const Padding(
